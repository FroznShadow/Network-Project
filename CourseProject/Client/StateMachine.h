...
public:
	...
	virtual void Update(DeltaTime time, sf::RenderWindow &window) = 0;
...
inline void StateMachine::Update(DeltaTime time, sf::RenderWindow &window)
{
	stateList[size]->Update(time,window);
}
